        ...
        <section id="cs">
            <div class="main">
                ...
                <section class="notice">
                    ...
                    <ul>
                    	<c:forEach var="notArticle" items="${notArticles}">
                        <li>
                            <a href="/Kmarket/cs/notice/view.do?notNo=${notArticle.notNo }&cate1=${notArticle.cate1}" class="title">${notArticle.notTitle }</a>
                            <span class="date">${notArticle.rdate.substring(2, 10)}</span>
                        </li>
                        </c:forEach>
                    </ul>
                </section>
                ...
                <section class="qna">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="./qna/view.do?qnaNo=${article.qnaNo}&cate1=${article.cate1}" class="title">[${article.c2Name}]${article.qnaTitle}</a>
                            <p>
                    ...
                    <a href="./qna/write.do?cate1=1" class="ask">문의글 작성 ></a>
                </section>
                <section class="tel">
